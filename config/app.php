...
return [
    ...
    'hydration' => [
         ...
         *
         * ⚠ 這一個設定決定當天發得出幾組封包批號，不夠用是會停線的：
         *
         *     pack_ones                pack_step   block    decimal
         *     '0123456789'             3            143 組   120 組   ← 預設
         *     '0123456789'             1            359 組   359 組
         *     '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'  3      432 組   432 組
         *     '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'  1     1295 組  1295 組
         *
         * 目前現場估「一天最多一千筆左右」，預設的 143 組明顯不夠，
         * 但要改成哪一種取決於封包批號的既有格式（後一碼能不能出現英文字母），
         * 這件事要跟封包端確認過再改。
